...
class QNetworkDistributional(nn.Module):
    ...
    def __init__(self, state_size, action_size, layers=[64, 64], n_atoms=51, v_min=-200.0, v_max=200.0):
        super().__init__()
...
class QNetworkNoisy(nn.Module):
    ...
    def __init__(self, state_size, action_size, layers=[64, 64], sigma_init=0.5):
        super().__init__()
